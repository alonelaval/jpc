...
repository_template = open("../template/daoImpl.temp","r").read()
def create_repository_file(entity_name):
    ...
    repository = open("/Users/hua/workspace/python/create_jpa/test/"+entity_name+"DaoImpl.java","w")
    repository.write(repository_content)
    repository.close()
    
    
if __name__ == '__main__':
    for line in read_dao("/Users/hua/workspace/ycz/cornerstone/entity/src/main/java/com/okycz/cornerstone/entity/biz",["User","OrgOrder","UserEvaluate"]):
