 ...
 * @author  huawei
 */
public class BaseRepositoryImpl<T extends IEntity, ID extends Serializable> extends QuerydslJpaRepository<T,ID> implements BaseRepository<T , ID>
{
    ...
    @Modifying
    @Override
    public void updateState(Integer state,List<Integer> ids){
